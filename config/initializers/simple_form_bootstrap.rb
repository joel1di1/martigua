...
SimpleForm.setup do |config|
  ...
  config.wrappers :bs_horizontal, tag: 'div', class: 'form-group', error_class: 'error' do |b|
    b.use :html5
    b.use :placeholder
    b.use :label
  ...
  config.wrappers :inline_checkbox, :tag => 'div', :class => 'control-group', :error_class => 'error' do |b|
    ...
    b.wrapper :tag => 'div', :class => 'form-group' do |ba|
      ba.wrapper :tag => 'div', :class => 'col-lg-offset-2 col-lg-10' do |bb|
        bb.wrapper :tag => 'div', :class => 'checkbox' do |bc|
